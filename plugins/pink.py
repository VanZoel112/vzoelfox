...
def get_emoji(emoji_type):
    ...
    # Fallback emojis (berdasarkan data UTF-16 yang valid)
    fallback_emojis = {
        'main': '🤩',
        'check': '⚙️',     # UTF-16 length: 2, ID: 5794353925360457382
        'adder1': '⛈',     # UTF-16 length: 1, ID: 5794407002566300853
        'adder2': '✅',     # UTF-16 length: 1, ID: 5793913811471700779
        'adder3': '👽',     # UTF-16 length: 2, ID: 5321412209992033736
        'adder4': '✈️',     # UTF-16 length: 2, ID: 5793973133559993740
        'adder5': '😈',     # UTF-16 length: 2, ID: 5357404860566235955
        'adder6': '🎚️'     # UTF-16 length: 2, ID: 5794323465452394551
    }
